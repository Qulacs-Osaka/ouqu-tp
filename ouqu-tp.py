...
from qulacs.gate import Identity,X,U3,merge,RZ,CNOT,sqrtX

import cmath
from cmath import isclose,phase,pi,sqrt,atan
...
for input in input_list:
    if input[0]=="U":
        newgate=merge(bitSingleGates[input[4]],U3(input[4],input[1],input[2],input[3]))
